    ...
    public class Home : Activity, BeaconManager.IServiceReadyCallback
    {
        ...
        private void InitializeBeacons()
        {
            ...
            for (int i = 0; i < Store.Instance.Locations.Count; i++)
            {
                ...
                //TODO Commented out since unknown error       Region beaconRegion = new Region(tempLocation.Nickname, tempLocation.BeaconGuid, System.Convert.ToInt32(tempLocation.Major), System.Convert.ToInt32(tempLocation.Minor));
                Console.WriteLine(tempLocation.Nickname + " " + tempLocation.BeaconGuid + " " + tempLocation.Major + " " + tempLocation.Minor);
                //TODO Commented out since uknown error        beaconManager.StartMonitoring(beaconRegion);
            }
        }
