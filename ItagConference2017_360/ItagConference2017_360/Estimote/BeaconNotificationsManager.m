...
- (void)beaconManager:(id)manager didEnterRegion:(CLBeaconRegion *)region {
    ...
    Event *proximityEvent = [[Store SharedInstance] ProximityEvent:[region minor] withMajor:[region major]];
    
    if (proximityEvent != nil)
    {
        NSString *message= [NSString stringWithFormat:@"You are near the event: %@", proximityEvent.Name];
...
- (void)beaconManager:(id)manager didExitRegion:(CLBeaconRegion *)region {
    ...
    if (proximityEvent != nil)
    {
        //NSString *message= [NSString stringWithFormat:@"You are leaving the event: %@", proximityEvent.Name];
        //[self showNotificationWithMessage:message];
        ...
        [[Store SharedInstance] NewSession:proximityEvent withEntering:false withBlock:sessionBlock];
